...
class TestFitbitClient:
	...
	def test_create_using_token(self):
		...
		client = FitbitClient.create_using_token(client_id=client_id,callback_uri=callback_uri,token=token)
	...
	def test_OAuth2_step_one(self):
		...
		authorization_url = FitbitClient.OAuth2_step_one(client_id=client_id,callback_uri=callback_uri)
